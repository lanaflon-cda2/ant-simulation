...
public final class ToricPosition {
    ...
    private static Vec2d clampedPosition(double x, double y) {
        int REFX = getConfig().getInt(WORLD_WIDTH);
        int REFY = getConfig().getInt(WORLD_HEIGHT);
    ...
    public Vec2d toricVector(ToricPosition that) {
        ...
        possibilities[1] = that.add(new Vec2d(0, getConfig().getInt(WORLD_HEIGHT)));
        possibilities[2] = that.add(new Vec2d(getConfig().getInt(WORLD_WIDTH), 0));
        possibilities[3] = that.add(new Vec2d(getConfig().getInt(WORLD_WIDTH), getConfig().getInt(WORLD_HEIGHT)));
        possibilities[4] = that.add(new Vec2d(-getConfig().getInt(WORLD_WIDTH), getConfig().getInt(WORLD_HEIGHT)));
        possibilities[5] = that.add(new Vec2d(getConfig().getInt(WORLD_WIDTH), -getConfig().getInt(WORLD_HEIGHT)));
        possibilities[6] = that.add(new Vec2d(-getConfig().getInt(WORLD_WIDTH), -getConfig().getInt(WORLD_HEIGHT)));
        possibilities[7] = that.add(new Vec2d(-getConfig().getInt(WORLD_WIDTH), 0));
        possibilities[8] = that.add(new Vec2d(0, -getConfig().getInt(WORLD_HEIGHT)));
