...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double minQty = Context.getConfig().getDouble(PHEROMONE_THRESHOLD);
...
System.out.println((termit2.getMinAttackStrength()== Context.getConfig().getInt(TERMITE_MIN_STRENGTH)));
        System.out.println((termit2.getMaxAttackStrength() == Context.getConfig().getInt(TERMITE_MAX_STRENGTH)));
        System.out.println(termit2.getMaxAttackDuration().equals(Context.getConfig().getTime(TERMITE_ATTACK_DURATION)));
